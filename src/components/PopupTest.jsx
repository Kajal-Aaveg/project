        ...
        <div className='w-[50%] bg-gradient-to-b flex-col justify-center from-[#110d2e] via-[#211d33] to-[#36364d] max-sm:w-full shadow-[0px_13px_40px_-15px_black] relative'>
         <span className='absolute top-2 right-4 text-white cursor-pointer z-50 ' onClick={closeTerms}><CancelIcon /></span>
          ...
          <div className=' px-20 mt-3 max-sm:px-5 '>
            ...
            {validationForm.fields.name && validationForm.fields.name.errors && validationForm.fields.name.errors[0] && (
              <p className="text-red-500">{validationForm.fields.name.errors[0]}</p>
            )}
            ...
            {validationForm.fields.number && validationForm.fields.number.errors && validationForm.fields.number.errors[0] && (
              <p className="text-red-500">{validationForm.fields.number.errors[0]}</p>
            )}
